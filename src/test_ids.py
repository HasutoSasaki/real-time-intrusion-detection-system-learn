...
def test_ids():
    ...
    # Train the anomaly detector with sample normal traffic data
    # In a real scenario, this would be trained on historical normal traffic
    import numpy as np
    normal_traffic = np.random.rand(100, 3) * 100  # 100 samples, 3 features
